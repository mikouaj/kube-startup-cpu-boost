...
import (
	...
	autoscalingv1alpha1 "github.com/mikouaj/kube-startup-cpu-boost/api/v1alpha1"
	"github.com/mikouaj/kube-startup-cpu-boost/internal/boost"
	"github.com/mikouaj/kube-startup-cpu-boost/internal/controller"
	"github.com/mikouaj/kube-startup-cpu-boost/internal/util"
	boostWebhook "github.com/mikouaj/kube-startup-cpu-boost/internal/webhook"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8fd077db.stefaniak.dev",
